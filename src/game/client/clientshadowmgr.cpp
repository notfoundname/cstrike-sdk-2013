...
static ConVar r_worldlight_castshadows("r_worldlight_castshadows", "1", FCVAR_NONE, "Allow world lights to cast shadows", true, 0, true, 1, WorldLightCastShadowCallback);
static ConVar r_worldlight_lerptime("r_worldlight_lerptime", "0.01", FCVAR_NONE);
static ConVar r_worldlight_debug("r_worldlight_debug", "0", FCVAR_NONE);
static ConVar r_worldlight_shortenfactor("r_worldlight_shortenfactor", "1", FCVAR_NONE, "Makes shadows cast from local lights shorter");
static ConVar r_worldlight_mincastintensity("r_worldlight_mincastintensity", "0.35", FCVAR_NONE, "Minimum brightness of a light to be classed as shadow casting", true, 0, false, 0);
